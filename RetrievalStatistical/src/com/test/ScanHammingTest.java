        ...
        List<String> resultList = new ArrayList<String>();
            while(in.hasNextLine()) {
                ...
                if (String.valueOf(i).equals(str)) {
                    ...
                    if(i<=42 && rate >= 0.4){
                        k++;
                    }else if((i>42&&i<=58) &&(rate>=0.4)){
                        l++;
                    }else if((i>58&&i<=141) &&(rate>=0.4)){
                        m++;
                    }else if ((i>141&&i<=187) && (rate>=0.4)){
                        n++;
                    }
...
//                            + ((numSum.get(187)-numSum.get(141))/46))/4);
        ...
        System.out.println((float)k/37);
        System.out.println((float)l/8);
        System.out.println((float)m/77);
        System.out.println((float)n/28);
        System.out.println(((float)k/37+(float)l/8+(float)m/77+(float)n/28)/4);
